(function (g) {
    ...
    i.ext.buttons.excelFlash = g.extend({}, t, {
        ...
        action: function (a, b, d, c) {
            var a = c._flash, e = 0, f = g.parseXML(o["xl/worksheets/sheet1.xml"]),
                h = f.getElementsByTagName("sheetData")[0], d = {
                    ...
                    for (var b = 0, c = a.length; b < c; b++) {
                        ...
                        if (!(null === a[b] || a[b] === p || "" === a[b])) {
                            a[b] = g.trim(a[b]);
                            for (var n = 0, o = z.length; n < o; n++) if (i = z[n], a[b].match && a[b].match(i.match)) {
                                j = a[b].replace(/[^\d\.\-]/g, "");
                                i.fmt && (j = i.fmt(j));

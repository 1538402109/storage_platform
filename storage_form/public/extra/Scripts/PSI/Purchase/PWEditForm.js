...
Ext.define("PSI.Purchase.PWEditForm", {
    ...
    initComponent: function() {
        ...
        me.columnGoodsName = Ext.getCmp("columnGoodsName");
    ...
    onOKCheck: function() {
        ...
        if (me.isConfirmDate) {
            me.confirm("有记录并没有维护生产日期,确定提交吗？", function() {
                me.onOK();
            });
        } else {
            me.onOK();
    ...
    getGoodsGrid: function() {
        ...
        Ext.define(modelName, {
            ...
            fields: ["id", "goodsId", "goodsCode", "goodsName", "batchDate", "unitResult",
                "goodsSpec", "unitName", "goodsCount", "unit2Decimal", "unit2Name", "unit3Decimal", "unit3Name", {
                    name: "goodsMoney",
                    type: "float"

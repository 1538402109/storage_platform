...
Ext.define("PSI.Report.SaleMonthByWarehouseForm", {
    ...
    onPrintPreview: function() {
        ...
        var r = {
            url: PSI.Const.BASE_URL +
                "Home/Report/genSaleMonthByWarehousePrintPage",
            params: {
            ...
            callback: function(options, success, response) {
                ...
                if (success) {
                    ...
                    me.previewReport("销售月报表(按仓库汇总)", data);
                }
            }
        };
        me.ajax(r);
    ...
    onPrint: function() {
        ...
        var r = {
            ...
            callback: function(options, success, response) {
                ...
                if (success) {
                    var data = response.responseText;
                    me.printReport("销售月报表(按仓库汇总)", data);
                }
            }
        };
        me.ajax(r);
    ...
    onPDF: function() {
        ...
        var url = "Home/Report/saleMonthByWarehousePdf?limit=-1&year=" + year +
            "&month=" + month;
        if (sorter) {
            url += "&sort=" + sorter;
        }

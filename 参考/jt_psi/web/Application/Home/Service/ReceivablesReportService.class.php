...
class ReceivablesReportService extends PSIBaseExService {
	...
	public function receivablesAgeQueryData($params) {
		...
		$rsStr = $ds->buildSQLStr2(FIdConst::REPORT_RECEIVABLES_AGE, "r", $loginUserId);
		...
		$rsStr = $ds->buildSQLStr2(FIdConst::REPORT_RECEIVABLES_AGE, "t_receivables_detail", $loginUserId);
		...
		$rsStr = $ds->buildSQLStr2(FIdConst::REPORT_RECEIVABLES_AGE, "t_receivables", $loginUserId);
	
		$sql = "select count(*) as cnt
				from t_receivables
				where company_id = '%s' and ".$rsStr."
				";

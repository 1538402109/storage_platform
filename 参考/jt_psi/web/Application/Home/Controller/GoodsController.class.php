...
class GoodsController extends PSIBaseController {
	...
	public function editGoods() {
		if (IS_POST) {
			...
			$params = array(
					...
					"taxRate" => I("post.taxRate"),
					"lev2SalePrice" => I("lev2SalePrice"),
					"salePrice2" => I("post.salePrice2"),
					"salePrice3" => I("post.salePrice3"),
					"unit2Id" => I("post.unit2Id"),
					"unit2Decimal" => I("post.unit2Decimal"),
					"unit3Id" => I("post.unit3Id"),
					"unit3Decimal" => I("post.unit3Decimal"),
					"guaranteeDay" => I("post.guaranteeDay"),
					"locality" => I("post.locality")
			);
			$gs = new GoodsService();
	...
	public function getGoodsCode(){
		if (IS_POST) {
			$ss = new GoodsService();
			$this->ajaxReturn($ss->getGoodsCode());
		}
	}
	 ...
	 * 添加商品分类时获取最新的分类编码
	 */
	public function getCatgoryCode(){
		if (IS_POST) {
			$ss = new GoodsService();
			$this->ajaxReturn($ss->getCatgoryCode());
		}
	}

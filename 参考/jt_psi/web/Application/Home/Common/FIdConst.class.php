...
class FIdConst {
	 ...
	 * 微信绑定/解绑
	 */
	const WEIXIN_BINDING = "-10000";

	/**
	 * 人员管理
	 */
	const PERSONNEL_MANAGEMENT = "-10001";

	/**
	 * 人员管理 - 新增人员 - 按钮权限
	 */
	const PERSONNEL_MANAGEMENT_ADD = "-10001-01";

	/**
	 * 人员管理 - 编辑人员 - 按钮权限
	 */
	const PERSONNEL_MANAGEMENT_EDIT = "-10001-02";

	/**
	 * 人员管理 - 删除人员 - 按钮权限
	 */
	const PERSONNEL_MANAGEMENT_DELETE = "-10001-03";

	/**
	 * 人员管理 - 修改用户密码 - 按钮权限
	 */
	const PERSONNEL_MANAGEMENT_CHANGE_PASSWORD = "-10001-04";

	/**
	 * 公告管理
	 */
	const NOTICE_MANAGEMENT = '-10002';

	/**
	 * 公告管理-新增公告分类 - 按钮权限
	 */
	const NOTICE_MANAGEMENT_ADD = '-10002-01';

	/**
	 * 公告管理-编辑公告分类 - 按钮权限
	 */
	const NOTICE_MANAGEMENT_EDIT = '-10002-02';

	/**
	 * 公告管理-删除公告分类 - 按钮权限
	 */
	const NOTICE_MANAGEMENT_DELETE = '-10002-03';

	/**
	 * 公告管理-新增公告 - 按钮权限
	 */
	const NOTICE_ADD = '-10002-04';

	/**
	 * 公告管理-编辑公告 - 按钮权限
	 */
	const NOTICE_EDIT = '-10002-05';

	/** 
	 * 公告管理-删除公告 - 按钮权限
	 */
	const NOTICE_DELETE = '-10002-06';
	 ...
	 * 销售出库 - 申请物流配送
	 */
	const WAREHOUSING_TMS_ORDER = "2002-08";
	 ...
	 * 销售退货入库 - 审核
	 */
	const SALE_REJECTION_VERIFY = "2006-07";
	/**
	 * 销售退货入库 - 取消审核
	 */
	const SALE_REJECTION_UNVERIFY = "2006-08";

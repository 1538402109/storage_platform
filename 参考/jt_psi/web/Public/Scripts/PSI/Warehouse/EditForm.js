...
Ext.define("PSI.Warehouse.EditForm", {
    ...
    initComponent: function() {
        ...
        Ext.apply(me, {
            ...
            items: [{
                ...
                {
                    id: "PSI_Warehouse_EditForm_editIsSale",
                    xtype: "combo",
                    queryMode: "local",
                    editable: false,
                    valueField: "id",
                    ...
                    hidden: me.adding,
                    value: entity == null ?
                        1 : parseInt(entity.get("isSale"))
                },
                 {
                    id: "PSI_Warehouse_EditForm_hiddenIsSale",
                    xtype: "hidden",
                    name: "isSale"
                },
                {
        ...
        me.editIsSale = Ext.getCmp("PSI_Warehouse_EditForm_editIsSale");
        me.hiddenIsSale = Ext.getCmp("PSI_Warehouse_EditForm_hiddenIsSale");
    },
    ...
    onOK: function(thenAdd) {
        ...
        me.hiddenIsSale.setValue(me.editIsSale.getValue());
        var f = me.editForm;
        var el = f.getEl();

		...
		me.__inventoryGrid = Ext.create("Ext.grid.Panel", {
					...
					columns : [{
								...
								renderer : function(value) {
									return value > 0
											? "<a href=\"Home/Report/safetyInventory\" class=\"x-btn x-unselectable x-btn-default-small x-noicon x-btn-noicon x-btn-default-small-noicon\" style=\"margin-right:10px\"><span class=\"x-column-header-text fontwhite\" style=\"color:blue\">查看详情</span></a><span style=\"color:red\">"
													+ value + "</span>"
											: value;
								}
							}, {

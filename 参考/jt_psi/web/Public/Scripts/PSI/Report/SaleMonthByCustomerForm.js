...
Ext.define("PSI.Report.SaleMonthByCustomerForm", {
    ...
    onPrintPreview: function() {
        ...
        var r = {
            url: PSI.Const.BASE_URL +
                "Home/Report/genSaleMonthByCustomerPrintPage",
            params: {
            ...
            callback: function(options, success, response) {
                ...
                if (success) {
                    ...
                    me.previewReport("销售月报表(按客户汇总)", data);
                }
            }
        };
        me.ajax(r);
    ...
    onPrint: function() {
        ...
        var r = {
            ...
            callback: function(options, success, response) {
                ...
                if (success) {
                    var data = response.responseText;
                    me.printReport("销售月报表(按客户汇总)", data);
                }
            }
        };
        me.ajax(r);
    ...
    onExcel: function() {
        ...
        var url = "Home/Report/saleMonthByCustomerExcel?limit=-1&year=" + year +
            "&month=" + month;
        if (sorter) {
            url += "&sort=" + sorter;
        }

...
Ext.define("PSI.App", {
    ...
    createMainMenu: function(root) {
        ...
        theCmp.addTool({
            xtype: "tbtext",
            text: "<span class='fontwhite' style='color:#196d6d;font-weight:bold;font-size:13px'>当前用户：" +
                me.getUserName() + "&nbsp;</span>"
        });
    },
    ...
    setAppHeader: function(header) {
        ...
        var title = "<span  class='fontwhite' style='font-size:140%;color:#196d6d;font-weight:bold;'>" +

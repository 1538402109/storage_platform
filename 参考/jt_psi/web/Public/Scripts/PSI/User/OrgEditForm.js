...
Ext.define("PSI.User.OrgEditForm", {
    ...
    initComponent: function() {
        ...
        Ext.apply(me, {
            ...
            items: [{
                ...
                items: [{
                        ...
                        id: "PSI_User_OrgEditForm_editAreaCode",
                        fieldLabel: "区划编码",
                        allowBlank: true,
                        blankText: "没有输入区划编码",
                        name: "areaCode",
                        ...
                        id: "PSI_User_OrgEditForm_editPrintUrl",
                        fieldLabel: "打印地址",
                        blankText: "例：http://127.0.0.1:8000",
                        name: "printUrl",
                        value: entity === null ? null : entity
                            .get("printUrl"),
                        listeners: {
                    ...
                    {
                        id: "PSI_User_OrgEditForm_editPrintTemplet",
                        fieldLabel: "打印模板",
                        allowBlank: true,
                        blankText: "没有输入区划编码",
                        name: "printTemplet",
                    ...
                    {
                        id: "PSI_User_OrgEditForm_editSoBillCheck",
                        xtype: "combo",
                        queryMode: "local",
                        editable: false,
                        valueField: "id",
                        ...
                        id: "PSI_User_OrgEditForm_editSoInterfaceStyle",
                        xtype: "combo",
                        queryMode: "local",
                        editable: false,
                        valueField: "id",
        ...
        me.editPrintUrl = Ext.getCmp("PSI_User_OrgEditForm_editPrintUrl");
        me.editPrintTemplet = Ext.getCmp("PSI_User_OrgEditForm_editPrintTemplet");
        me.editSoBillCheck = Ext.getCmp("PSI_User_OrgEditForm_editSoBillCheck");
        me.editAreaCode = Ext.getCmp("PSI_User_OrgEditForm_editAreaCode");
        me.editForm = Ext.getCmp("PSI_User_OrgEditForm_editForm");
        //界面风格
        me.soInterfaceStyle = Ext.getCmp("PSI_User_OrgEditForm_editSoInterfaceStyle");
    },
        ...
        me.ajax({
            ...
            callback: function(options, success, response) {
                ...
                if (success) {
                    ...
                    me.editAreaCode.setValue(data.areaCode);
                    me.editPrintUrl.setValue(data.printUrl);
                    me.editPrintTemplet.setValue(data.printTemplet);
                    me.editSoBillCheck.setValue(parseInt(data.soBillCheck));
                    //界面风格
                    me.soInterfaceStyle.setValue(parseInt(data.interface_style));
